        ...
        switch(propPosition){
            case 0: // right
                ...
                trajBackdrop = myBot.getDrive().actionBuilder(new Pose2d(10, 34, 0))
                        .strafeToLinearHeading(new Vector2d(37.8, 28.5), Math.toRadians(180));
                break;
            case 1: // center
                trajStart = myBot.getDrive()
                        .actionBuilder(new Pose2d(12, 60, Math.toRadians(90)))
                ...
                trajBackdrop = myBot.getDrive().actionBuilder(new Pose2d(10, 34, Math.toRadians(90)))
                        ...
                        .strafeToLinearHeading(new Vector2d(37.8, 35.5), Math.toRadians(180));
...
//                fTrajEnd.build()
    ...
    private static RoadRunnerBotEntity blueFar(MeepMeep meepMeep) {
        ...
        switch(propPosition){
            case 0: // right
//                trajStart = myBot.getDrive().actionBuilder(new Pose2d(0, 0, 0))
//                        .splineToSplineHeading(new Pose2d(40, 40, Math.toRadians(45)), 0)
//                        .splineToSplineHeading(new Pose2d(-40, 40, Math.toRadians(45)), Math.PI);
                ...
                .strafeToLinearHeading(new Vector2d(-38, 45), Math.toRadians(45))
                        .splineToSplineHeading(new Pose2d(-36, 34, 0), Math.toRadians(270))
